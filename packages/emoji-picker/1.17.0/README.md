...
**Versioning Note:** This package version (1.17.0) follows the [Unicode Emoji version 17.0](https://unicode.org/emoji/charts-17.0/emoji-released.html) that it supports. Future updates will track new Unicode Emoji releases.
